  ...
  <div class="container mx-auto h-screen flex flex-column justify-center">
    ...
    <form action="../database/database.php" method="POST" class="register h-1/2 p-4 max-w-7xl self-center justify-self-center shadow-lg shadow-gray-400/40 rounded-lg grid grid-cols-4 gap-3 grid-rows-5 md:m-0 ml-24 mr-24">
      <div class="user row-start-1 md:col-span-2 col-span-4">
        ...
        <input class="peer border border-sky-500 rounded-full min-w-full h-fit focus:outline-none focus:ring focus:ring-sky-500" type="email" name="email" />
      ...
      <div class="user row-start-2 md:col-span-2 col-span-4">
        ...
        <input class="border border-sky-500 rounded-full min-w-full h-fit focus:outline-none focus:ring focus:ring-sky-500" type="text" name="user" />
      </div>
      <div class="psw row-start-3 md:col-span-2 col-span-4">
        <label for="psw">Senha</label> <br />
        <div class="relative">
          <input id="senha" class="border border-sky-500 rounded-full h-fit min-w-full focus:outline-none focus:ring focus:ring-sky-500" type="password" name="psw" oninput="password()" />
      ...
      <div class="psw row-start-4 md:col-span-2 col-span-4">
        ...
        <div class="relative">
          <input id="repetSenha" class="border border-sky-500 rounded-full h-fit min-w-full focus:outline-none focus:ring focus:ring-sky-500" type="password" name="Rpsw" oninput="password()" />

...
<body>
  ...
  <form action="database.php" method="POST" class="container min-w-full min-h-screen grid">
    <input type="hiden" name="acao" value="esquecisenha" class="hidden">
    <div
      class="login p-4 h-96 w-80 self-center justify-self-center shadow-lg shadow-gray-400/40 rounded-lg grid grid-cols-1 gap-3 grid-rows-4 gap-4">
      <div class="Code">

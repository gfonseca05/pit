...
<body>
  ...
  <form action="" class="container min-w-full min-h-screen grid">
    <div class="login p-4 h-96 w-80 self-center justify-self-center shadow-lg shadow-gray-400/40 rounded-lg grid grid-cols-2 gap-3 grid-rows-4 gap-4">

      <div class="user row-start-1 col-start-1 col-end-3">
        <label for="user">Email</label> <br />
        <input class="peer border border-sky-500 rounded-full min-w-full h-12 focus:outline-none focus:ring focus:ring-sky-500" type="email" name="user" />
      ...
      <div class="psw row-start-2 col-start-1 col-end-3">
        ...
        <div class="relative">
          <input id="senha" class="border border-sky-500 rounded-full h-12 min-w-full focus:outline-none focus:ring focus:ring-sky-500" type="password" />
          <i class="absolute top-0 right-0 h-full w-5 flex items-center justify-center mr-4 cursor-pointer" onclick="viewPSW()">
            <img id="eye" src="../assets/eye-closed-svgrepo-com.svg"></img>
          </i>
        </div>
      </div>

      <a href="../index.php" class="text-base guest row-start-3 col-start-1 rounded-lg bg-zinc-400 transition duration-400 ease-in-out hover:bg-zinc-500 flex">
        <button class="">
          Convidado
        </button>
      </a>
      <button class="text-base logar row-start-3 col-start-2 rounded-lg bg-sky-500 transition duration-400 ease-in-out hover:bg-sky-400">
        Entrar
      </button>
      <button class="text-base google row-start-4 col-start-1 col-end-3 rounded-lg bg-zinc-100 transition duration-700 ease-in-out hover:bg-zinc-50">
      ...
      <div class="goToLogin col-span-2 text-blue-600 text-xs">
        ...
        <a href="../Password/password.php" class="underline underline-offset-1 ml-8">Esqueci minha Senha</a>
      </div>

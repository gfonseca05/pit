...
<body class="h-full">
    ...
    <div class="grid grid-cols-2 grid-rows-3 gap-3 place-content-center container mx-auto mt-48">
        ...
        <form method="POST" action="../../../database/poolTable/poolinsert.php"
            class="sliders row-start-3 col-span-2 mb-10 flex">
            <div class="sliders w-1/2 p-3">
                <div id="sliderContainer" class="w-full h-1/3">
                    ...
                    <input type="range" name="width" id="widthSlider" min="1" max="10" step="1" class="w-full"
                        oninput="updateValue('widthValue',this.value)">
                </div>
                <div id="sliderContainer" class="w-full h-1/3">
                    <label for="heightSlider">Profundidade:</label> <span id="heightValue">6m</span> </br>
                    <input type="range" name="height" id="heightSlider" min="1" max="10" step="1" class="w-full"
            ...
            <input
                class="border cursor-pointer border-sky-500 rounded-xl p-2"
                type="submit" value="Adicionar Piscina">
        </form>
    </div>
    <svg class="bottom-0" id="wave" style="transform: rotate(0deg); transition: 0.3s" viewBox="0 0 1440 120"
        version="1.1" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
